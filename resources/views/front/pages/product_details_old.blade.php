                    ...
                    <div class="col-md-6">
                        <div class="product-gallery">
                            <figure class="product-main-image">
                                <img id="product-zoom" src="{{ URL::asset('admin/app-assets/images/products/'.$product_main_image_medium) }}" data-zoom-image="{{ URL::asset('admin/app-assets/images/products/'.$product_main_image_big) }}" alt="product image">
                            ...
                            <div id="product-zoom-gallery" class="product-image-gallery">
                                @foreach($product_images_small as $small)
                                <a class="product-gallery-item" href="#" data-image="assets/images/products/single/extended/1.jpg" data-zoom-image="assets/images/products/single/extended/1-big.jpg">
                                    <img src="{{ URL::asset('admin/app-assets/images/products/'.$small->image) }}" alt="product side">
                                </a>
                                @endforeach
