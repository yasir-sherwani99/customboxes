<head>
  ...
  <title>Admin Login - Custom Boxes Expert</title>
...
<!--  <link href="https://maxcdn.icons8.com/fonts/line-awesome/1.1/css/line-awesome.min.css') }}"
  ...
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('admin/app-assets/css/pages/login-register.css') }}">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
  ...
  <script src="{{ asset('admin/app-assets/js/scripts/custom/button-disabled.js') }}" ></script>
</head>