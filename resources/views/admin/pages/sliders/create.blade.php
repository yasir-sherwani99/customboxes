...
@section('breadcrums')
      ...
      <h3 class="content-header-title mb-0 d-inline-block">New Slider Image</h3>
      <div class="row breadcrumbs-top d-inline-block">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">New Slider
            </li>
          </ol>
        </div>
      </div>
  ...
  <div class="content-body">
    <section id="css-classes" class="card">
      ...
      <div class="card-content">
        <div class="card-body">
          <div class="card-text">
            <form class="form" method="POST" action="{{ route('admin.slider.store') }}" enctype="multipart/form-data" novalidate>
            {{ csrf_field() }}
            <div class="form-body">
              <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="title" class="form-control" placeholder="Slider title" required data-validation-required-message="Slider title field is required" name="title">
              ...
              <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    <label for="image" class="text-bold-600 black">Slider Image <span class="danger darken-4">*</span></label>
                    <input type="file" id="image" class="form-control" required data-validation-required-message="Slider image field is required" name="slider_image">
                    <small>Slider must be of size 1920x670</small>
                    <div class="help-block font-small-3"></div>
                  </div>
                </div>
              </div> 
