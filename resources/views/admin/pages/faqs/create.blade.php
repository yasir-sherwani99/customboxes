...
<script>
  ...
  $(document).ready(function(){
    ...
    $("body").on("click",".question_remove_btn", function(){ 
  ...
  <div class="content-body">
    <section id="css-classes" class="card">
      <div class="card-header">
        <h4 class="card-title float-left">New Faq</h4>
        <p class="float-right">
          <button class="btn btn-success question_add_btn" type="button"><i class="la la-plus font-small-3 text-bold-600"></i> Add</button>
        </p>
      </div>
      <div class="card-content">
        <div class="card-body">
          <div class="card-text">
            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.faqs.store') }}" novalidate>
            {{ csrf_field() }}
            <div class="form-body">
              <div class="increment">
                <div class="row">
                  <div class="col-md-12 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="question" class="form-control" required data-validation-required-message="Question field is required" name="question[]">
                      <div class="help-block font-small-3"></div>
                    </div>
                    <div class="form-group">
                      <label for="answer" class="text-bold-600 black">Answer <span class="danger darken-4">*</span></label>   
                      <textarea name="answer[]" id="answer" required data-validation-required-message="Answer field is required" class="form-control" rows="5"></textarea>
                      <div class="help-block font-small-3"></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="clone d-none">
                <div class="row">
                  <div class="col-md-12 col-12 bg-blue-grey bg-lighten-4 pt-2">
                    <div class="form-group">
                      <label for="question_new" class="text-bold-600 black">Question </label>   
                      <input type="text" id="question_new" class="form-control" name="question[]">
                    </div>
                    <div class="form-group">
                      <label for="answer_new" class="text-bold-600 black">Answer </label>   
                      <textarea name="answer[]" id="answer_new" class="form-control" rows="5"></textarea>
                    </div>
                    <div class="form-group text-right">
                      <button class="btn btn-danger question_remove_btn" type="button"><i class="la la-close font-small-3 text-bold-600"></i> Remove</button>
                    </div>
                  </div>
                </div>     
              </div>
