      ...
      <div id="recent-sales" class="col-12 col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title black">Client Messages</h4>
            ...
            <div class="table-responsive">
              <table id="recent-orders" class="table table-hover table-xl mb-0">
                ...
                <tbody>
                    ...
                    <td class="text-left" style="vertical-align: middle;">
                      <span class="dropdown">
                        ...
                        <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                            <a href="{{ route('admin.message.show', $message->id) }}" class="dropdown-item font-small-3"><i class="la la-eye font-medium-2"></i> View Details</a>
                  ...
                  @else
                  <tr>
                    <td colspan="3">There is no message to show here...</td>
                  </tr>
                  @endif
                </tbody>
                <tfoot>
                  <tr>
                      <td colspan="3">{{ $messages->links() }}</td>
                  </tr>
                </tfoot>
              </table>
            </div>
