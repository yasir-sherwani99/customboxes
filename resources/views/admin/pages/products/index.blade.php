          ...
          <div class="col-xl-3 col-md-3 col-12">
            <div class="card">
              ...
              <div class="card-content">
                ...
                @php
                  $sorted = $data->product->sortBy('id', SORT_REGULAR, false); 
                @endphp
                <div id="carousel-example" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                      <img src="{{ URL::asset('admin/app-assets/images/products/'.$image->image_medium) }}" class="d-block w-100" alt="First slide">
                    </div>
                    @endforeach
                  </div>
                ...
                <div class="card-body">
                  @php       
                    $desc_len = strlen($data->description); 
                    $desc_sub = substr($data->description, 0,100);
                    if($desc_len > 100){
              ...
              <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                ...
                <span class="tags float-right">
                  <span class="badge badge-pill badge-danger">{{ $data->category->title }}</span>
