...
@section('breadcrums')
	...
	<div class="content-header-left col-md-9 col-12 mb-2 breadcrumb-new">
      <h3 class="content-header-title mb-0 d-inline-block">Edit Page</h3>
    ...
    <div class="content-header-right col-md-3 col-12">
      <a href="{{ route('admin.pages.index') }}" class="btn btn-sm btn-danger box-shadow-2 round btn-min-width pull-right">View All</a>
    </div>  
...
<form class="form" method="POST" action="{{ route('admin.pages.update', $page->id) }}" enctype="multipart/form-data" novalidate>
{{ csrf_field() }}
{{ method_field('put') }}
          ...
          <div class="card-text">
              ...
              <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    <label for="title" class="text-bold-600">Page Title <span class="danger darken-4">*</span></label>
                    <input type="text" id="title" class="form-control" value="{{ $page->title }}" required data-validation-required-message="Page title field is required" name="title">
            ...
            <!--  <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="slug" class="form-control" value="{{ $page->slug }}" required data-validation-required-message="Slug field is required" name="slug">
              ...
              <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    ...
                    <textarea id="description" rows="5" class="form-control" name="description" placeholder="Page Description">{!! $page->description !!}</textarea>
                  </div>
                </div>
              </div>
              <div class="row icheck_minimal skin">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    ...
                    <br/>
                    <input type="radio" name="status" id="input-radio-5" required data-validation-required-message="Category status field is required" value="1" {{ $page->status == 1 ? 'checked' : '' }}  /> <label for="input-radio-5">Active</label>
                    <br/>
                    <input type="radio" name="status" id="input-radio-6" required data-validation-required-message="Category status field is required" value="0" {{ $page->status == 0 ? 'checked' : '' }} /> <label for="input-radio-6">Deactive</label>
                    <div class="help-block font-small-3"></div>
                  </div>
                </div>
              </div>
            ...
            <div class="form-actions text-center">
              <button type="submit" class="btn btn-info btn-glow px-2">
               ...
               <span class="without-load">Update Page</span>
              </button>
            </div>
        ...
        <div class="row">
          <div class="col-md-12 col-12">
            <div class="form-group">
              ...
              <input type="text" id="page_title" class="form-control always-show-maxlength" value="{{ $page->page_title }}" name="page_title" maxlength="57">
        ...
        <div class="row">
          <div class="col-md-12 col-12">
            <div class="form-group">
              ...
              <textarea class="form-control textarea-maxlength" id="page_description" name="page_description" placeholder="Page description" maxlength="250">{{ $page->page_description }}</textarea>
        ...
        <div class="row">
          <div class="col-md-12 col-12">
            <div class="form-group">
              ...
              <input type="text" id="page_keyword" class="form-control always-show-maxlength" value="{{ $page->page_keywords }}" name="page_keywords" maxlength="190">
