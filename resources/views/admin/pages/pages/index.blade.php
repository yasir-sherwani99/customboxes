      ...
      <div id="recent-sales" class="col-12 col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title black">Pages</h4>
              ...
              <table id="recent-orders" class="table table-hover table-xl mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="border-top-0" style="width: 80%;">Title</th>
                ...
                <tbody>
                    ...
                    <td class="text-left" style="vertical-align: middle;">
                      <span class="dropdown">
                        ...
                        <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">
                          <a href="{{ route('admin.pages.edit', $page->id) }}" class="dropdown-item font-small-3"><i class="la la-edit font-medium-2"></i> Edit Page</a>
                  ...
                  @else
                  <tr>
                    <td colspan="3">There is no page to show here...</td>
                  </tr>
                  @endif
                </tbody>
                <tfoot>
