    ...
    <div class="content-body">
      <section id="css-classes" class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <div class="card-text">
              <form class="form" method="POST" action="{{ route('admin.administrators.update', $admin->id) }}" enctype="multipart/form-data" novalidate>
              {{ csrf_field() }}
              {{ method_field('put') }}
              <div class="form-body">
                <div class="row">
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="first_name" class="form-control" value="{{ $admin->first_name }}" required data-validation-required-message="First name field is required" name="first_name">
                  ...
                  <div class="col-md-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="last_name" class="form-control" value="{{ $admin->last_name }}" required data-validation-required-message="Last name field is required" name="last_name">
                      <div class="help-block font-small-3"></div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row icheck_minimal skin">
                  <div class="col-md-12 col-12">
                    <div class="form-group">
                      ...
                      <br/>
                      <input type="radio" name="status" id="input-radio-6" required data-validation-required-message="Status field is required" value="0" {{ $admin->status == 0 ? 'checked' : '' }} /> <label for="input-radio-6">Deactive</label>
                      <div class="help-block font-small-3"></div>
                    </div>
                  </div>
                </div>
