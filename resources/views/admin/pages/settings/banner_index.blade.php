  ...
  <div class="content-body">
    <section id="css-classes" class="card">
      <div class="card-header">
        <h4 class="card-title float-left">Banner</h4>
          ...
          <div class="card-text mb-2">
            <div class="row">
              <div class="col-md-12 col-12">
                <img src="{{ URL::asset('assets/images/demos/demo-24/slider/'.$banner->banner_image) }}" alt="Banner image" class="img-fluid" />
              </div>
            </div>
          </div>
          <div class="card-text">
            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.banner.update', $banner->id) }}" novalidate>
            {{ csrf_field() }}
            {{ method_field('put') }}
            <div class="form-body">
              <div class="row">
                <div class="col-md-12 col-12">
                  <div class="form-group">
                    <label for="banner" class="text-bold-600 black">Banner Image <span class="danger darken-4">*</span></label>   
                      <input type="file" id="banner" class="form-control" required data-validation-required-message="Banner image field is required" name="banner_image">
                      <small>Banner must be size of 1920 x 670 in pixels</small>
            ...
            <div class="form-actions text-center">
              <button type="submit" class="btn btn-info btn-glow px-2">
               ...
               <span class="without-load">Change</span>
              </button>
            </div>
            </form>
          </div>
